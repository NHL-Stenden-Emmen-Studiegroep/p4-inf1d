...
import { Alert, Dimensions, Image, Platform, ScrollView, StyleSheet, Switch, Text, TextInput, TouchableOpacity, View} from 'react-native';
...
export default function Home({ navigation }) {
    const { updateSelectedTask, deleteSelectedTask , todo } = useStore((state) => ({
